...
| ⚡ [**python-games**](https://github.com/marcpartensky/python-games) | Numerical simulation engine built from scratch: physics, particles, chaos equations, Mandelbrot, solar system dynamics |
 
| ❄️ [**nixos**](https://github.com/marcpartensky/nixos) | Fully declarative, reproducible NixOS environment — deterministic dep management for data science workflows |
 
| 🐳 [**docker**](https://github.com/marcpartensky/docker) | Self-hosted infra configs (Kubernetes, Docker Compose) |
 
| ⚙️ [**nvim**](https://github.com/marcpartensky/nvim) | Neovim config |
 
| 🌐 [**website**](https://github.com/marcpartensky/website) | Personal website |
